...
<script type="module">
  ...
  onAuthStateChanged(auth, (user) => {
    ...
    function showAbstract(title, abstract, session, authors, presenter) {
        ...
        document.getElementById('modalPresenter').textContent = presenter;
        ...
        result.forEach(entry => {
            tableBody += `
                <tr data-id="${entry._id}">
                    ...
                    <td>
                        <button class="btn btn-primary btn-sm" onclick="showAbstract(
                            '${encodeURIComponent(entry.title || "")}',
                            '${encodeURIComponent(entry.abstract || "")}',
                            '${encodeURIComponent(entry.session || "")}',
                            '${encodeURIComponent(entry.authors || "")}',
                            '${encodeURIComponent(entry.presenter || "")}'
                        )">View</button>
                    </td>
                    <td>
