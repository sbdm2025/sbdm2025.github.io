    ...
    result.forEach(entry => {
        tableBody += `
            <tr data-id="${entry._id}" style="vertical-align:middle">
                ...
                <div>
                    <select class="form-select editable" data-field="optoutGala">
                        <option value="true" ${entry.optoutGala ? "selected" : ""}>Yes</option>
                        <option value="false" ${!entry.optoutGala ? "selected" : ""}>No</option>
                    </select>
                </div>
                </td>
                <td><div>
