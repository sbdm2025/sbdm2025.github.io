    ...
    result.forEach(entry => {
        tableBody += `
            <tr data-id="${entry._id}">
                ...
                <td contenteditable="true" class="editable" data-field="affiliation"><div>${entry.affiliation}</div></td>
                ...
                <td contenteditable="false" data-field="discountRequest"><div>${entry.discountRequest}</div></td>
                <td><div>
