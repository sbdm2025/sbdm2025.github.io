...
<script type="module">
  ...
  onAuthStateChanged(auth, (user) => {
    ...
    function showAbstract(title, abstract, session) {
        ...
        result.forEach(entry => {
            tableBody += `
                <tr data-id="${entry._id}">
                    ...
                    <td><button class="btn btn-primary btn-sm" onclick="showAbstract('${entry.title.replace(/'/g, "\\'")}','${entry.abstract.replace(/'/g, "\\'")}','${entry.session.replace(/'/g, "\\'")}')">View</button></td>
                    <td>
