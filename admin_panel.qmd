    ...
    result.forEach(entry => {
        tableBody += `
            <tr data-id="${entry._id}" style="vertical-align:middle">
                ...
                <td contenteditable="true" class="editable" data-field="affiliation" style="color: ${entry.discountRequest ? 'inherit' : 'red'};"><div>${entry.affiliation}</div></td>
...
<div class="container-lg">
    ...
    <div class="container mt-4" id="user-container">
        ...
        <span>Affiliation highlighted in red are from low-income countries (and discount was requested)</span>
