...
<script type="module">
  ...
  const auth = getAuth(app);
    ...
    function displayGoogleForm(userEmail) {
        ...
        const googleFormEmbedUrl = `https://docs.google.com/forms/d/e/1FAIpQLScWF9cXG9kIy_PeChCBGnfY-f7oAuvOjayS2HLwUYlqgtngiA?entry.emailAddress=${encodeURIComponent(userEmail)}`;
