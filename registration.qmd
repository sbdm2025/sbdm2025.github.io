...
<script type="module">
  ...
  const auth = getAuth(app);
    ...
    if (user && user.emailVerified) {
        ...
        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLScWF9cXG9kIy_PeChCBGnfY-f7oAuvOjayS2HLwUYlqgtngiA/viewform?entry.emailAddress=${encodeURIComponent(user.email)}&embedded=true" width="640" height="403" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
        `;
