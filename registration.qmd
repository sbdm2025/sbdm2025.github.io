...
<script type="module">
  ...
  document.getElementById("signup-btn").addEventListener("click", async () => {
    ...
    try {
      ...
      document.getElementById("signup-password").setAttribute("autocomplete", "on");
  ...
  document.getElementById("registrationForm").addEventListener("submit", async function(event) {
    ...
    try {
      ...
      document.getElementById("responseMessage").innerText = result.message;
        ...
        }, 1500); // Wait for 2 seconds before refreshing (optional)
    } catch (error) {
    ...
    <div class="d-flex row justify-content-between flex-wrap" style="width:100%">
        ...
        <div style="width:45%">
            <div class="signup-container text-center" id="signup-container">
                ...
                <input type="email" id="signup-email" class="form-control" placeholder="Email" autocomplete="username">
                <input type="password" id="signup-password" class="form-control" placeholder="Password" autocomplete="new-password">
                <button type="submit" id="signup-btn" class="btn btn-success mt-2">Sign Up</button>
            </div>
        </div>
    </div>
        ...
        <div class="container mt-5" style="text-align:left">
            ...
            <form id="registrationForm">
                ...
                <div class="mb-3" id="authorsPoster">
                    ...
                    <input type="text" class="form-control" id="formAuthors" required>
                </div>
                <div class="mb-3" id="presenterPoster">
                    <label for="formPresenter" class="form-label">Presenter</label>
                    <input type="text" class="form-control" id="formPresenter" required>
                </div>
