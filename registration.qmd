...
Sign-up with a valid email address. A confirmation email will be sent to this address.

You will then be able to complete the registration form, and submit your abstract. 

Note that you may edit your registration form until the **1st of May 2025**. To do so, simply log in again with your credentials, update the fields of your choice, and resubmit the form.
...
[list]("files/List of low-income countries.pdf"){target="_blank"})
...
<div class="container-lg">
    ...
    <div class="d-flex row justify-content-between flex-wrap" style="width:80%">
        <div style="width:45%">
        ...
        <div class="container mt-5" style="text-align:left">
            ...
            <form id="registrationForm">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="formPresents" id="optionposter1" value="False" required>
