...
We are still in the process of securing funding to make registration as affordable as possible, especially for students and postdocs.
...
<script type="module">
  ...
  import { getAnalytics,signInWithEmailAndPassword, signOut, onAuthStateChanged } from "https://www.gstatic.com/firebasejs/11.4.0/firebase-analytics.js";
