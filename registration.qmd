  ...
  const auth = getAuth(app);
    ...
    onAuthStateChanged(auth, (user) => {
        if (!user.emailVerified) {
            ...
            document.getElementById("google-form-container").innerHTML = ""; // Clear form
        ...
        // Display Google Form
        displayGoogleForm(user.email);
    });

    function displayGoogleForm(userEmail) {
        // Replace 'YOUR_GOOGLE_FORM_EMBED_URL' with your actual Google Form embed URL
        const googleFormEmbedUrl = `https://docs.google.com/forms/d/e/1FAIpQLScWF9cXG9kIy_PeChCBGnfY-f7oAuvOjayS2HLwUYlqgtngiA/viewform?entry.emailAddress=${encodeURIComponent(userEmail)}`;

        // Create an iframe to embed the Google Form
        ...
        document.getElementById("google-form-container").innerHTML = ""; // Clear any existing form
