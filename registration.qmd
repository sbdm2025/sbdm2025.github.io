...
Registration for SBDM2025 is open!

### How to proceed

Sign-up with a valid email address. A confirmation email will be sent to
this address.

You will then be able to complete the registration form, and submit your
abstract.

Note that you may edit your registration form until the **1st of May
...
[list](%22files/List%20of%20low-income%20countries.pdf%22){target="_blank"})
...
<script type="module">
  ...
  document.getElementById("registrationForm").addEventListener("submit", async function(event) {
    ...
    const formData = {
      ...
      foodrestriction: document.getElementById("formFood").value,
      ...
      discountRequest: document.getElementById("formDiscount").value,
      email: user.email,
    };
    try {
            ...
            <form id="registrationForm">
                ...
                <div class="mb-3">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="formDiscount">If you are from a low-income country, you may request a discount on registration fee (not guaranteed) by ticking this box</label>
                    </div>
                </div>
                <div class="mb-3">
